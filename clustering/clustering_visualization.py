...
if __name__ == '__main__':
    ...
    cols = list(hdbscan.columns[1:37])
    for col in cols:
        boxplot_data = [hdbscan[hdbscan['cluster'] == cluster][col] for cluster in hdbscan['cluster'].unique()]
        ...
        plt.xlabel('Cluster')
        plt.ylabel(col)
        filename = '../images/clustering/hdbscan_' + col + '.png'
